...
import { signInWithEmailAndPassWord, getAuth, signInWithEmailAndPassword } from "firebase/auth";
            ...
            <div  className="w-full md:w-[67%] lg:w-[50%] lg:ml-1">
                <form onSubmit={onSubmit}>
                    ...
                    <div className="flex justify-between whitespace-nowrap text-sm sm:text-lg">
                        ...
                        <p>
                         <Link to="/forgot-password" className="text-blue-600 hover:text-blue-800 transition duration-200 ease-in-out ml-3">Forgot Password</Link>
                        </p>
                    </div>
