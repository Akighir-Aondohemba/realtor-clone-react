  ...
  setEmail(e.target.value);
    ...
    return (
        ...
        <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto">
            ...
            <div>
                <form className="w-full md:w-[67%] lg:w-[50%] lg:ml-20">
                    ...
                    <div className="flex justify-between whitespace-nowrap text-sm sm:text-lg">
                        ...
                        <p>
                         <Link to="/sign-in" className="text-blue-600 hover:text-blue-800 transition duration-200 ease-in-out ml-3">Sign in instead</Link>
                        </p>
                    </div>
                    <button className="w-full bg-blue-600 text-white px-7 py-3 text-sm font-medium uppercase rounded shadow-md hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800" type="submit">Set reset password</button>
